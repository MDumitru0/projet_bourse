...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        Action act1 = new Action(1, "Twitter", 165.15, 159, 100);
        ...
        //ajouter les actions chez les traders
    ...
    private void tblTradersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTradersMouseClicked
        ...
        {
            //On supprime TOUJOURS la premiere
            //A l'indice 0
        ...
        for (Trader trads : mesTraders) 
        {
            if (trads.getId() == numTrader) {
                for (Action acts : trads.getLesActions()) {
                v = new Vector();
                v.add(acts.getId());
                v.add(acts.getNom());
                v.add(acts.getCoursReel());
                v.add(acts.getPrixAchat());
                v.add(acts.getQuantite());
                dtmActions.addRow(v);
                //accumuler les 
